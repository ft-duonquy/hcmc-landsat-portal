...
const HCMC_POLYGON_COORDS = [
  ...
  [107.0347, 10.3993], [107.0180, 10.3720], [106.9890, 10.3732],
  [106.9601, 10.3840], [106.9298, 10.4085], [106.8997, 10.4271],
  [106.8695, 10.4431], [106.8388, 10.4598], [106.8078, 10.4746],
  [106.7759, 10.4900], [106.7445, 10.5090], [106.7110, 10.5231],
  [106.6763, 10.5311], [106.6418, 10.5350], [106.6074, 10.5303],
  [106.5735, 10.5204], [106.5421, 10.5041], [106.5106, 10.4852],
  [106.4807, 10.4630], [106.4507, 10.4425], [106.4227, 10.4196],
  [106.3989, 10.3975], [106.3779, 10.3818], [106.3605, 10.3718]
];
...
fetch('/api/boundary')
  .then(res => res.json())
  .then(boundary => {
    // Draw the bright green boundary line wrapper strictly around the border edges
    L.geoJSON(boundary, {
      interactive: false,
      pane: 'maskPane',
      style: {
